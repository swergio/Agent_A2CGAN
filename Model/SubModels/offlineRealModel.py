...
class offlineRealModel(object):

    def __init__(self,A,Q,H, sess, env, batch_size, latent_size, reuse=False, init_X_msg = None, msg_length = None, initLenght = None, is_training=True):
